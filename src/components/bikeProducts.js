  ...
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap -mx-3 mb-20">
      <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-0">
        <div class="relative mb-6 h-64 w-full bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${image})`}}>
        ...
        <div class="relative h-64 w-full bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${image})`}}>
          <a class="absolute inset-0 flex items-end" href="#">
            <div class="pl-12 pb-12">
              <h3 class="text-3xl font-bold font-heading text-white">.</h3>
            </div>
