  ...
  return (
    <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-0">
      <div class="relative mb-6 h-64 w-full bg-cover bg-no-repeat" style={{backgroundImage: `url(${image})`}}>
        <a class="flex w-full h-full justify-center items-center bg-black opacity-50 hover:opacity-75 transition duration-200 ease-in-out" href={`/rprod/${link.toLowerCase()}`}>
